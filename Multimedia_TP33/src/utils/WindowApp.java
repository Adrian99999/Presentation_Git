...
public abstract class WindowApp extends Application {
	...
	public void start(Stage primaryStage) {
		...
		Image icone = new Image("/ressources/mp3.png");
    	primaryStage.getIcons().add(icone);
    	
    	((MusiquePaneCtrl)app).chargerPreferences(primaryStage);
    	
		primaryStage.show();
		primaryStage.setOnCloseRequest(dontcare-> ((MusiquePaneCtrl)app).stockerPreferences());
	}
